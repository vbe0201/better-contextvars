...
"""
This implements a task-local storage for trio.
This demonstrates that better_contextvars has the same structure as the
original contextvars.

For reference, see:
https://trio.readthedocs.io/en/latest/reference-core.html#task-local-storage
"""
